...
export class SessionService {
    ...
    async createSession(
        ...
        try {
         ...
         VALUES ($1, $2, $3, $4, $5, $6, NOW() + INTERVAL '15 minutes', NOW() + INTERVAL '7 days')`,
            ...
            throw new AuthError('Error creando sesión', 'SESSION_CREATION_ERROR', 500);
        }
    }
    ...
    async getUserSessions(
        ...
        try {
         ...
         ORDER BY last_activity_at DESC`,
            ...
            const redisKeys = await getRedisClient().keys(`session:*:${companyId}:${userId}`);
            ...
            throw new AuthError('Error obteniendo sesiones', 'GET_SESSIONS_ERROR', 500);
        }
    }
    ...
    async revokeSession(
        ...
        try {
         ...
         WHERE id = $1 AND user_id = $2 AND company_id = $3`,
            ...
            throw new AuthError('Error revocando sesión', 'REVOKE_SESSION_ERROR', 500);
        }
    }
    ...
    async revokeOtherSessions(
        ...
        try {
            ...
            const sessions = await this.getUserSessions(userId, companyId, currentSessionId);
            ...
            throw new AuthError('Error revocando sesiones', 'REVOKE_OTHER_SESSIONS_ERROR', 500);
        }
    }
    ...
    async revokeAllSessions(userId: string, companyId: string): Promise<number> {
        try {
         ...
         RETURNING id`,
            ...
            throw new AuthError('Error revocando sesiones', 'REVOKE_ALL_SESSIONS_ERROR', 500);
        }
    }
    ...
    async getSessionDetails(sessionId: string): Promise<any> {
        try {
         ...
         WHERE us.id = $1`,
            ...
            throw new AuthError('Error obteniendo sesión', 'GET_SESSION_DETAILS_ERROR', 500);
        }
    }
