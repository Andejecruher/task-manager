...
type AuditLogsCreationAttributes = Optional<AuditLogsAttributes, 'id' | 'performed_at' | 'old_data' | 'new_data' | 'diff' | 'user_ip' | 'user_agent'>;

class AuditLogs extends Model<AuditLogsAttributes, AuditLogsCreationAttributes> implements AuditLogsAttributes {
    public id!: string;
